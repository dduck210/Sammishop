...
// thêm danh mục sản phẩm
    public function insert(){
        $sql_insert="Insert into categories(`name`,`avatar`,`content`,`status`,`category_status`)
        VALUES (:name,:avatar,:content,:status,:category_status)";
...
//    chỉnh sửa danh mục
    public function update($id){
        $sql_update="Update categories set `name`=:name,`status`=:status,`category_status`=:category_status,`avatar`=:avatar,`content`=:content,`updated_at`=:updated_at where id=$id";
