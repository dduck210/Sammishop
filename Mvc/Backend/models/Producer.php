...
// thêm danh mục sản phẩm
    public function insert(){
        $sql_insert="Insert into producers(`name`,`avatar`,`status`)
...
//    chỉnh sửa danh mục
    public function update($id){
        $sql_update="Update producers set `name`=:name,`status`=:status,`avatar`=:avatar,`updated_at`=:updated_at where id=$id";
