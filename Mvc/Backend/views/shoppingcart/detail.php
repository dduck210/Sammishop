...
?>
<?php
if($order["status"] !=1 && $order["status"] !=3 && ($_SESSION["user_admin"]["status"] == 0) ):
  ?>
...
<div class="box">
    ...
    <div>
        <a style="margin-left: 15px"
            href="<?php echo ($_SESSION["user_admin"]["status"] == 1) ? 'index.php?area=backend&controller=shipping' : 'index.php?area=backend&controller=ShoppingCart'; ?>"
