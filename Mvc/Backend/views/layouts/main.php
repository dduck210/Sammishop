...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="https://theme.hstatic.net/1000246282/1000726217/14/favicon.png?v=223">
            ...
            <section class="sidebar">
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p><?php echo isset($_SESSION["user_admin"]["fullname"]) ? $_SESSION["user_admin"]["fullname"] : 'Trần Hải Nam'; ?>
                        </p>
                ...
                <ul class="sidebar-menu" data-widget="tree" style="border-top: 1px solid aqua;">
                    ...
                    <?php endif; ?>
                    <li><a href="index.php?area=Backend&controller=login&action=logout"
                            onclick="return confirm('Bạn có chắc chắn muốn đăng xuất không ?')"><i
                                class="fa fa-lock"></i> <span>Đăng xuất</span></a></li>
