...
<div style="text-align: right;margin-bottom: 15px;">
    <a href="index.php?area=backend&controller=category&action=create" class="btn btn-success"><i
            ...
            <tr>
                ...
                <td>
                    ...
                    <img style="margin: 10px 0px;border-radius: 3px;"
                        src="Assets/Uploads/categories/<?php echo $category['avatar']; ?>" width="90" height="80" />
                    <?php endif; ?>
                </td>
                <td>
                    <?php
                ...
                <td style="text-align: center">
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=category&action=detail&id=<?php echo $category['id']; ?>">
                        <i class="fa fa-eye "></i></a>
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=category&action=update&id=<?php echo $category['id'] ?>">
