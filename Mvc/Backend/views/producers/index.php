...
<div style="text-align: right;margin-bottom: 15px;">
    <a href="index.php?area=backend&controller=producer&action=create" class="btn btn-success"><i
            ...
            <tr>
                ...
                <td>
                    ...
                    <img style="margin: 10px 0px;border-radius: 3px;"
                        src="Assets/Uploads/producers/<?php echo $producer['avatar']; ?>" width="90" height="80" />
                    <?php endif; ?>
                </td>
                <td>
                    <?php
                ...
                <td style="text-align: center">
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=producer&action=detail&id=<?php echo $producer['id']; ?>">
                        <i class="fa fa-eye "></i></a>
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=producer&action=update&id=<?php echo $producer['id'] ?>">
