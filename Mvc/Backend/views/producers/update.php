        ...
        <form role="form" id="producer_form" enctype="multipart/form-data" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name"
                    value="<?php echo isset($producer["name"]) ? $producer["name"] : $_POST['name'] ?>"
                    class="form-control" placeholder="Tên của thương hiệu ...">
            </div>
            <!-- textarea -->
            <div class="form-group">
                ...
                <img style="margin: 10px 0px; border-radius: 3px"
                    src="Assets/Uploads/producers/<?php echo $producer['avatar']; ?>" height="70" width="100" />
                <?php endif; ?>
            </div>
            <!-- input states -->
            <div class="form-group">
...
$("#producer_form").validate({
    ...
    messages: {
        ...
        status: {
            required: " * Chọn trạng thái của thương hiệu"
        }
