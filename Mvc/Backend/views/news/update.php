        ...
        <form role="form" id="news_form" enctype="multipart/form-data" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name"
                    value="<?php echo isset($news["name"]) ? $news["name"] : $_POST['name'] ?>" class="form-control"
                    placeholder="Tên của tin tức ...">
            </div>
            <!-- textarea -->
            <div class="form-group">
                ...
                <img style="margin: 10px 0px; border-radius: 3px"
                    src="Assets/Uploads/news/<?php echo $news['avatar']; ?>" height="70" width="100" />
                <?php endif; ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="summary" id="summary" rows="5"
                    placeholder="Miêu tả chi tiết tin tức ..."><?php echo isset($news['summary']) ? $news["summary"] : "" ?></textarea>
            </div>
            <div class="form-group">
                <label for="content">Miêu tả chi tiết tin tức :</label>
                <textarea class="form-control" name="content" id="content" rows="5"
                    placeholder="Miêu tả chi tiết tin tức ..."><?php echo isset($news['content']) ? $news["content"] : "" ?></textarea>
            </div>
            <!-- input states -->
            <div class="form-group">
                <?php
...
$("#news_form").validate({
    ...
    messages: {
        name: {
            required: " * Bạn phải nhập tên tin tức"
        },
        avatar: {
            extension: "Phải tải ảnh lên đúng định dạng "
        },
        status: {
            required: " * Chọn trạng thái của tin tức"
        },
        news_status: {
            required: " * Chọn phân loại cho tin tức"
        }
