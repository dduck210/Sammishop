        ...
        <form role="form" id="news_form" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="summary" id="summary" rows="5"
                    placeholder="Miêu tả ngắn tin tức ..."><?php echo isset($_POST['content']) ? $_POST["content"] : "" ?></textarea>
            </div>
            <!--       -->
            <div class="form-group">
                <label for="content">Mô tả chi tiết tin tức :</label>
                <textarea class="form-control" name="content" id="content" rows="5"
                    placeholder="Miêu tả chi tiết tin tức ..."><?php echo isset($_POST['content']) ? $_POST["content"] : "" ?></textarea>
            </div>
...
$("#news_form").validate({
    ...
    messages: {
        ...
        category_id: {
            required: " * Chọn danh mục cho tin tức"
        }
    }
});
</script>