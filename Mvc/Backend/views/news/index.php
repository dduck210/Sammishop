...
<div style="text-align: right;margin-bottom: 15px;">
    <a href="index.php?area=backend&controller=news&action=create" class="btn btn-success"><i class="fa fa-plus"></i>
        Thêm tin tức</a>
</div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img style="margin: 10px 0px;border-radius: 3px;"
                        src="Assets/Uploads/news/<?php echo $new['avatar']; ?>" width="90" height="80" />
                    <?php endif; ?>
                </td>
                <td>
                ...
                <td style="text-align: center">
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=news&action=detail&id=<?php echo $new['id']; ?>">
                        <i class="fa fa-eye "></i></a>
                    <a style="margin-right: 10px;"
                        href="index.php?area=backend&controller=news&action=update&id=<?php echo $new['id'] ?>">
