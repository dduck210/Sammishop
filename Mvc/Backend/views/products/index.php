...
<div style="margin: 10px auto;width: 60%">
    <input style="padding: 22px 12px; border-radius: 5px" type="text" id="search_text" name="search_product"
        class="form-control" placeholder="Nhập từ khóa cần tìm kiếm .......">
</div>
<div style="text-align: right;margin-bottom: 15px;">
    <a href="index.php?area=backend&controller=product&action=create" class="btn btn-success"><i class="fa fa-plus"></i>
        Thêm sản phẩm mới</a>
</div>
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        ...
                        <img style="margin: 10px 0px;border-radius: 3px;"
                            src="Assets/Uploads/products/<?php echo $product['avatar']; ?>" width="90" height="80" />
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php
                    ...
                    <td style="text-align: center">
                        ...
                        <a style="margin-right: 10px;"
                            href="index.php?area=backend&controller=product&action=update&id=<?php echo $product['id'] ?>">
