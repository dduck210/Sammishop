        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="footer-support">
                    <h5 style="margin-bottom: 20px;text-align: center;font-weight: bold;text-transform: uppercase">Thông
                        tin khách hàng</h5>
                    <input type="hidden" name="user_id"
                        value="<?php if(isset($_SESSION["user_account"]) && !empty($_SESSION["user_account"])): echo $_SESSION["user_account"]["id"];   else: echo "";  endif;?>">
                    <div class="form-group">
                        ...
                        <p class="error"><?php echo isset($this->error['fullname']) ? $this->error['fullname'] : '' ?>
                        </p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" readonly class="form-control"
                            placeholder="Nhập Email nhận thông tin về đơn hàng" value="<?php if(isset($_SESSION["user_account"]) && !empty($_SESSION["user_account"]['email'])){
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" id="" cols="30" rows="5" placeholder="Ghi chú thêm"
            ...
            <div class="col-md-6 col-sm-6">
                <h5 style="margin-bottom: 20px;text-align: center;font-weight: bold;text-transform: uppercase"
                    class="center-align">Thông tin đơn hàng</h5>
                <?php
                $total_cart=0;
                $total_discount=0;
                $total=0;
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="<?php echo $product_link; ?>"><img class="mp-10"
                                        src="assets/uploads/products/<?php echo $cart['avatar']; ?>" width=100"
                                        height="60"></a>
                                <?php endif; ?>
