                ...
                <div class="hot-product">
                    <div class="border">
                        <div class="product_img">
                            ...
                            <div class="price_sale"><?php echo $product['discount']; ?>% <span
                                    class="sale_lable"></span>
                            </div>
                            <?php endif; ?>
                            <div class="product_cart">
                                <div class="product_detail line_left"><a
                                        href="them-vao-gio-hang/<?php echo $product["id"];?>"><i
                                            class="fa fa-shopping-cart"></i>&nbsp; Thêm
                                        vào giỏ</a></div>
                                <div class="product_detail"><a href="<?php echo $product_link; ?>"><i
                                            class="fa fa-eye"></i>&nbsp;
                                        Xem chi tiết</div>
                                </a>
                        ...
                        <div>
                            ...
                            <?php if($product['discount'] > 0): ?>
                            <p><span style="margin-left:5px;text-decoration: line-through !important;color: grey"
                                    class="price"><?php echo number_format($product["price"]-($product["price"]*($product["discount"]/100))); ?>
                                    ₫</span>
                                &nbsp <span style="color: #dc1c4c;font-weight: bold"
                                    class="price-label"><?php echo number_format($product["price"]); ?> ₫</span>
                            </p>
                            <?php else: ?>
                            <p>&nbsp;<span style="margin-left:5px;color: #dc1c4c;font-weight: bold" class="price-label"
                                    class="price-label"><?php echo  number_format($product["price"]); ?> ₫</span>
                            </p>
                            <?php endif; ?>
                        </div>
